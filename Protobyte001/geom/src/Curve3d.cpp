...
Curve3d::Curve3d(Vector3df controlPt0, Vector3df controlPt1, Vector3df controlPt2, Vector3df controlPt3, int interpDetail): 
controlPt0(controlPt0), controlPt1(controlPt1), controlPt2(controlPt2), controlPt3(controlPt3), interpDetail(interpDetail) {
    controlPtsLength = 4;
    controlPts = new Vector3df[controlPtsLength];
    controlPts[0] = controlPt0; controlPts[1] = controlPt1; controlPts[2] = controlPt2; controlPts[3] = controlPt3;
}

Curve3d::Curve3d(Vector3df controlPt0, Vector3df controlPt1, Vector3df controlPt2, Vector3df controlPt3,int interpDetail, bool isCurveClosed): 
...
Curve3d::Curve3d(Vector3df controlPt0, Vector3df controlPt1, Vector3df controlPt2, Vector3df controlPt3, Vector3df controlPt4, Vector3df controlPt5, int interpDetail): 
...
Curve3d::Curve3d(Vector3df controlPt0, Vector3df controlPt1, Vector3df controlPt2, Vector3df controlPt3, Vector3df controlPt4, Vector3df controlPt5, int interpDetail, bool isCurveClosed): 
...
Curve3d::Curve3d(Vector3df controlPt0, Vector3df controlPt1, Vector3df controlPt2, Vector3df controlPt3, Vector3df controlPt4, Vector3df controlPt5, Vector3df controlPt6, Vector3df controlPt7, int interpDetail): 
...
Curve3d::Curve3d(Vector3df controlPt0, Vector3df controlPt1, Vector3df controlPt2, Vector3df controlPt3, Vector3df controlPt4, Vector3df controlPt5, Vector3df controlPt6, Vector3df controlPt7, int interpDetail, bool isCurveClosed): 
...
Curve3d::Curve3d(Vector3df* controlPts, int controlPtsLength, int interpDetail): 
controlPts(controlPts), controlPtsLength(controlPtsLength), interpDetail(interpDetail) {
}

Curve3d::Curve3d(Vector3df* controlPts, int controlPtsLength, int interpDetail, bool isCurveClosed): 
 ...
 */
Vector3df Curve3d::getControlPt0() const {
    return controlPt0;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt0(Vector3df controlPt0) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt1() const  {
    return controlPt1;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt1(Vector3df controlPt1) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt2() const  {
    return controlPt2;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt2(Vector3df controlPt2) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt3() const  {
    return controlPt3;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt3(Vector3df controlPt3) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt4() const  {
    return controlPt4;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt4(Vector3df controlPt4) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt5() const  {
    return controlPt5;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt5(Vector3df controlPt5) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt6() const  {
    return controlPt6;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt6(Vector3df controlPt6) {
 ...
 * @return Vector3df object
 */
Vector3df Curve3d::getControlPt7() const  {
    return controlPt7;
}
 ...
 *            Vector3df object
 */
void Curve3d::setControlPt7(Vector3df controlPt7) {
 ...
 * with side effects
 */
void Curve3d::setControlPts(Vector3df* controlPts) {
 ...
 * with side effects
 */
Vector3df* Curve3d::getControlPts() {
    return controlPts;
}
 ...
 *            Vector[] array
 */
void Curve3d::setVerts(Vector3df* verts) {
    this->verts = verts;
 ...
 */
std::vector<Vector3df> Curve3d::getVertices(){
    return tempVecs;
    //return verts;
